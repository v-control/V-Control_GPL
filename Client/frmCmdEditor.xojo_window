...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub ShowError(Line as integer, ErrorNumber as integer)
		  Dim i as integer
...
#tag Events cmdSave
	#tag Event
		Sub Action()
		  frmDeviceEditor.txtCmdScript.Text = txtScript.Text
		  frmDeviceEditor.txtCmdScript.ColorSyntax(frmDeviceEditor.txtCmdScript.Text,0)
		  frmCmdEditor.Close
		End Sub
	#tag EndEvent
#tag EndEvents
