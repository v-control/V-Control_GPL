#tag Window
Begin Window frmCuesetSelector
   BackColor       =   &cFFFFFF00
   Backdrop        =   0
   BalloonHelp     =   ""
   CloseButton     =   True
...
#tag WindowCode
	...
	#tag Property, Flags = &h0
		#tag Note
			//wenn 1 dann CallAsFunction, 2 CallAsThread, 3 StopTask
		#tag EndNote
		...
		Sub Action()
		  ...
		  if frmMain.tbProgram.Value = 0 then
		    ...
		    if InsertFunction = 1 then
		      frmMain.lstCues.Cell(Li,3) = "CallAsFunction"
		    end
		    if InsertFunction = 2 then
		      frmMain.lstCues.Cell(Li,3) = "CallAsThread"
		    end
		    if InsertFunction = 3 then
		      frmMain.lstCues.Cell(Li,3) = "StopTask"
		    end
		  ...
		  if frmMain.tbProgram.Value = 1 then
		    ...
		    if InsertFunction = 1 then
		      Clp.SetText "CallAsFunction("+""""+SelCueset+""""+")" +chr(13)
		    end
		    
		    if InsertFunction = 2 then
		      Clp.SetText "CallAsThread("+""""+SelCueset+""""+")" +chr(13)
		    end
		    if InsertFunction = 3 then
		      Clp.SetText "StopTask("+""""+SelCueset+""""+")" +chr(13)
		    end
		  ...
		  if frmMain.tbProgram.Value = 2 then
		    ...
		    if InsertFunction = 1 then
		      Clp.SetText "CallAsFunction"+chr(10)+"("+""""+SelCueset+""""+")" 
		    end
		    
		    if InsertFunction = 2 then
		      Clp.SetText "CallAsThread"+chr(10)+"("+""""+SelCueset+""""+")" 
		    end
		    if InsertFunction = 3 then
		      Clp.SetText "StopTask"+chr(10)+"("+""""+SelCueset+""""+")"
		    end
